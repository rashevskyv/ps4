...
Копирование и восстановление через пейлоад нужно делать отдельно для каждого аккаунта! Войдите в аккаунт, который вы хотите забекапить и продолжайте выполнять инструкции!
{: .notice--warning}
