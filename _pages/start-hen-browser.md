...
1. В адресной строке введите один из указанных адресов:
  + `devcrono.github.io/crono_dreambox/`
  + `leeful.github.io/672v8/`
  + `leeful.github.io/v10/`
1. Кеширование начнется автоматически
...
{% include inc/launch-exploit.md 
	...
	fw='"**6.72**"'
	payload='"**Exploit + HEN**", или "**HEN + VR**", или "**HEN 3.0.0**", в зависимости от того, что есть в выбранном эксплойт-хосте'
