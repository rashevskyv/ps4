...
**О:** Нет, сохранения от лицензии не подходят! Но это не точно. Думаю, если дамп будет максимально такой же, что и купленная игра (ID-диска, цифра или лицензия), то все заработает.
