...
**О:** Нет, в данный момент даунгрейда не существует. И нет, вы не сможете установить старую прошивку, просто поменяв жёсткий диск. 

### **В:** Как узнать прошивку по серийному номеру ревизии?
**О:** С помощью этого [сайта](https://defaultdnb.github.io/PS4IDENT/index.html){:target="_blank"}
...
**О:** Если шлем попросит обновить прошивку - сделайте это. Подключите и включите VR перед активацией взлома. Имейте ввиду, что шлем, обновлённый на приставке с новой прошивке не будет работать на прошитой PS4.

### **В:** Можно ли использовать Remote Play? 
**О:** [Да](remote-play){:target="_blank"} 

### **В:** Как бороться с ошибкой "Пользователь User1 будет выведен из системы PS4 из-за ошибки (NP 36006-5)"? 
**О:** Зайдите в трофеи, выйдите и пробуйте залогиниться снова
...
**О:** На HEN 1.7 и выше перенос делается стандартными средствами консоли! 
...
### **В:** Хватит ли флешки на XX Гб для установки игр?
