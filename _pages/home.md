...
header:
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по взлому PS4 / PS4 PRO на стоковой прошивке версии 9.00 и ниже<br />**Последнее изменение:** 14 декабря'
---

{% include toc title="Разделы" %}

Здесь собрана самая базовая информация. После запуска эксплойта рекомендуется читать тематические группы и форумы, для того, чтобы наиболее оптимально использовать прошитую приставку. Данный сайт не является сборником всех инструкций со всего интернета!
{: .notice--info}
...
Конечная цель этого руководства - это установка HEN на PS4 с официальной прошивкой версии до {% include /vars/sys_version.txt %} включительно. В зависимости от текущей версии прошивки на вашей приставке, мы повысим её до рекомендуемой, если это необходимо, а так же заблокируем доступ к серверам обновления SONY для того, чтобы случайно не поднять версию прошивки до самой высокой.
