...
header:
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Повний посібник зі зламу PS4/PS4 PRO на стіковій прошивці версії 13.00 та нижче'
---
...
Вдумливо прочитайте кожну вступну сторінку інструкції (включно з цією!) перед тим, як почати. Ознайомтеся з [FAQ](faq){:target="_blank"}, [Глосарієм](glossary){:target="_blank"} та пройдіться по посібнику, подумки виконуючи кроки, що відповідають вашій конфігурації. 
{: .notice--warning}
