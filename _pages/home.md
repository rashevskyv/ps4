...
header:
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке запуску HEN на PS4 / PS4 PRO на стоковой прошивке версии 4.05 и ниже<br />**Последнее изменение:** 24 января 2018'
---
...
Это руководство создано на базе руководства уважаемого [MeatWad](https://tapochek.net/viewtopic.php?t=205689&start=0#) с сайта tapocheck.net.
{: .notice--success}
...
В большинстве случаев запуск Homebrew на 100% бесплатен и использует [интернет браузер PS4](start-hen). 
